...
//			datacenter1.printDebts();
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		for(int i = 0; i<size; i++) {
			...
			waitingTime[i] = (float) Double.parseDouble(dft.format(cloudlet.getExecStartTime()));
		}
		for(int i=0; i<size; i++) {
			a[i] = burstTime[i];
		}
		...
		Log.printLine("Cloudlet ID" + indent + "STATUS" + indent +
				"Data center ID" + indent + "VM ID" + indent + indent + "Time" + indent + "Start Time" + indent + "Finish Time" +indent+ "Priority" +indent+ "Waiting Time" +indent+ indent + "Turn Around Time");
		...
		for (int i = 0; i < size; i++) {
			...
			if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS){
				...
				Log.printLine( indent + indent + indent+ cloudlet.getResourceId() + indent + indent + indent + cloudlet.getVmId() +
						...
						indent + indent  + dft.format(cloudlet.getExecStartTime())+ indent + indent  + dft.format(cloudlet.getFinishTime())+indent+indent + indent +cloudlet.getPriority() + indent + indent + indent + waitingTime[i] + indent + indent + indent + turnAroundTime[i]);
